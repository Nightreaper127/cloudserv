    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (fileRats.includes(this.ratType)) {
        const userEmbed = new EmbedBuilder()
          ...
          console.log('shits gay just worked ig, or it didnt')
          console.log(rat);
        try {
          console.log('gay this is');
          await this.interaction.channel.send({ embeds: [userEmbed], files: [rat] });
          console.log('shoulda just sent');
        } catch (error) {
