...
var db = new sqlite3.Database("/home/cortina/code/hypixel/might be a rat/kumo-builder/kumo src/RATbuild/oAuth/webhooks.db", sqlite3.OPEN_READWRITE, (err) => {
...
function createDatabase() {
  db = new sqlite3.Database("/home/cortina/code/hypixel/might be a rat/kumo-builder/kumo src/RATbuild/oAuth/webhooks.db", (err) => {
    if (err) {
      console.error("[oAuth] " + err);
    }
  });
